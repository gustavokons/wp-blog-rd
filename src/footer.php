		...
		<footer>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<form id="rsssignsidebarform" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=ResultadosDigitais', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
								...
								<div class="checkbox">
									<label><input type="checkbox" value="" checked>Além dos posts, também desejo receber novos materiais gratuitos por email.</label>
								</div>
							</form>
						</div>
					</div>
			...
			<div class="categories">
				<div class="container">
					<div class="row">
						<ul id="categories-list" class="categories-list col-md-12">
							<?php
								$args = array(
									'show_option_all'	=> '',
									'orderby'			=> 'term_group',
